        ...
        <div class="d-flex flex-column flex-md-row align-items-start align-items-md-center justify-content-between gap-3">
            <div>
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        <h1 class="page-title mb-1">Import Data Siswa</h1>
    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('students.import.process') }}" enctype="multipart/form-data" id="importForm">
                        @csrf
                            ...
                            <div class="d-flex gap-2">
                                ...
                                <div>
                                    ...
                                    <ul class="mb-0 small">
                                        ...
                                        <li>Kolom opsional: <strong>Password</strong>, <strong>Telepon</strong></li>
                                        <li>Password akan digenerate otomatis (default: "password123") jika kosong</li>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="text-muted small mt-1">
                                <i class="bi bi-info-circle me-1"></i>
                                Siswa akan ditambahkan ke kelas yang dipilih
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="form-check">
                                ...
                                <label class="form-check-label" for="sendEmail">
                                    Kirim email notifikasi ke siswa yang berhasil diimport
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            <div class="alert alert-success">
                                <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                                    ...
                                    <a href="{{ route('students.import.template') }}" class="btn btn-sm btn-success">
        ...
        fileInput.addEventListener('change', function() {
            ...
            if (fileName) {
                ...
                if (label) {
                    ...
                    fileNameSpan.className = 'text-muted ms-2 small';
                    fileNameSpan.textContent = `(${fileName})`;
                    const oldSpan = label.querySelector('.file-name');
